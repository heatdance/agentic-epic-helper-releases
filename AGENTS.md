...
| **Epic orchestrator** (`/epic-helper`, one stage per turn) | [docs/epic-helper-contract.json](docs/epic-helper-contract.json) (**v6**) · [epic-helper.md](.cursor/commands/epic-helper.md) · [automation/docs/epic-helper.md](automation/docs/epic-helper.md) |
...
| Epic close (integrity + archive) | [epics/templates/close-ref.json](epics/templates/close-ref.json) · `epics/<KEY>/context/<KEY>-close.json` · **three** root `.md` (coverage, analysis, tests; precon optional legacy) · trigger `CLOSE:` (documentation-only; optional **`strict_topology=yes`** / **`strict_principal=yes`**; after ref, coverage, discover, tests at epic root) |
