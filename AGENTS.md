...
| **Grounding integration** (coaches, shipped core, regression gate) | [docs/grounding-integration.json](docs/grounding-integration.json) · coaches [`/better-prompt`](.cursor/commands/better-prompt.md) · [`/better-skill`](.cursor/commands/better-skill.md) · verify `powershell -File .cursor/scripts/corner-harness-verify.ps1` |
| **Delivery smoke automation** (pytest + Playwright; not `automation/`) | [auto-tests/](auto-tests/) · [`/teach`](.cursor/commands/teach.md) · [docs/auto-tests-contract.json](docs/auto-tests-contract.json) |
| **Epic orchestrator** (`/crtqa-helper`, one stage per turn) | [docs/crtqa-helper-contract.json](docs/crtqa-helper-contract.json) · [crtqa-helper.md](.cursor/commands/crtqa-helper.md) · [automation/docs/crtqa-helper.md](automation/docs/crtqa-helper.md) |
| **Karpathy coding discipline** (opt-in skill) | [docs/karpathy-guidelines-contract.json](docs/karpathy-guidelines-contract.json) · [`.cursor/skills/karpathy-guidelines/SKILL.md`](.cursor/skills/karpathy-guidelines/SKILL.md) — attach when implementing/refactoring `automation/tools/` Python |
...
| **Corner release notes** (four PMOPROC JQLs per fixVersion; **personal-only** `releases/**`) | [releases/README.md](releases/README.md) · [docs/release-notes-contract.json](docs/release-notes-contract.json) · **`/release-notes`** [release-notes.md](.cursor/commands/release-notes.md) · [release_notes.py](automation/tools/release_notes.py) |
...
| **CRTQA TCD stats (v5)** | [docs/crtqa-stats-contract.json](docs/crtqa-stats-contract.json) · skill [`.cursor/skills/crtqa-stats/SKILL.md`](.cursor/skills/crtqa-stats/SKILL.md) (greenfield) · `/crtqa-stats` [crtqa-stats.md](.cursor/commands/crtqa-stats.md) · [stats/crtqa-stats/README.md](stats/crtqa-stats/README.md) · per-user [crtqa_stats_rollup.py](automation/tools/crtqa_stats_rollup.py) · team [crtqa_stats_team_rollup.py](automation/tools/crtqa_stats_team_rollup.py) |
...
| Custom commands (**`/crtqa-env`**, **`/crtqa-console`**, **`/crtqa-stats`**, **`/crtqa-calibrate`**, **`/release-notes`**, **`/clean`**, **`/crtqa-helper`**, **`/better-prompt`**, **`/better-skill`**, **`/teach`**) | [.cursor/commands/](.cursor/commands/) — env [crtqa-env.md](.cursor/commands/crtqa-env.md); console [crtqa-console.md](.cursor/commands/crtqa-console.md); stats [crtqa-stats.md](.cursor/commands/crtqa-stats.md); calibrate [crtqa-calibrate.md](.cursor/commands/crtqa-calibrate.md); release notes [release-notes.md](.cursor/commands/release-notes.md); publish [clean.md](.cursor/commands/clean.md); helper [crtqa-helper.md](.cursor/commands/crtqa-helper.md); coaches [better-prompt.md](.cursor/commands/better-prompt.md) · [better-skill.md](.cursor/commands/better-skill.md) (Conversation-only); teach [teach.md](.cursor/commands/teach.md) (`/teach stop` exits) |
| Opt-in skills (**karpathy-guidelines**, **crtqa-stats**, **crtqa-helper**) | [karpathy-guidelines](.cursor/skills/karpathy-guidelines/SKILL.md) — `automation/` Python; [crtqa-stats](.cursor/skills/crtqa-stats/SKILL.md) — stats; [crtqa-helper](.cursor/skills/crtqa-helper/SKILL.md) — epic orchestrator |
...
| Corner harness hygiene (coaches/hooks) | [corner-harness-verify.ps1](.cursor/scripts/corner-harness-verify.ps1) · [automation/docs/corner-harness-verify.md](automation/docs/corner-harness-verify.md) |
