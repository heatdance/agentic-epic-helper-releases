...
from epic_stats.categories import TOP_CATEGORY_LABELS, classify_epic
from epic_stats.ingest import REPO_ROOT, load_contract
...
def epic_categories_path(contract: dict[str, Any] | None = None) -> Path:
    ...
    rel = (c.get("paths") or {}).get(
        "epic_categories", "stats/epic-stats/epic-categories.json"
    )
