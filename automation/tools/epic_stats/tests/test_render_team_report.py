from epic_stats.render_team_report import aggregate_team_band, render_team_markdown
...
def test_render_team_markdown_header_and_table(monkeypatch) -> None:
    ...
    import epic_stats.render_team_report as tr
...
def test_pack_user_collapsed_bands_micro() -> None:
    from epic_stats.render_report import pack_user_collapsed_bands
