#!/usr/bin/env python3
"""Render stats/epic-stats/latest-<user>.md from v5 state."""
...
from epic_stats.categories import TOP_CATEGORY_LABELS, TOP_CATEGORY_ORDER
from epic_stats.epic_breakdown import render_epic_breakdown_sections
...
def pack_user_collapsed_bands(
    ...
    c = contract or load_contract()
    from epic_stats.ingest import rows_for_report
