# CRT-594 — fixture shell_first + principal threads (pass 2 reinforce)
...
> Verified on CTQA: show prices EUR/USD — bid/ask from first TextConfiguration tier.
...
> daily_data_recorder_config show; backup_price after snapshot.
