#!/usr/bin/env python3
"""
Render stats/epic-stats/latest-team.md from user state files.

Examples:
  python automation/tools/epic_stats_team_rollup.py
  python automation/tools/epic_stats_team_rollup.py --users mshpak,amukanova
"""
...
from epic_stats.render_team_report import render_team_markdown  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Epic stats team rollup")
    parser.add_argument(
        "--users",
        default="",
