#!/usr/bin/env python3
"""
Recompute and render stats/crtqa-stats/latest-<jira_user>.md (schema v5).
...
from crtqa_stats.render_report import render_latest_markdown  # noqa: E402


def _longitudinal_path(contract: dict) -> Path:
    rel = (contract.get("paths") or {}).get(
        "longitudinal", "stats/crtqa-stats/state/longitudinal.json"
    )
