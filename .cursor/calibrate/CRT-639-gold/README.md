...
**`/epic-calibrate`** will **hard stop** at **`gold_distinct`** (`GOLD_NOT_DISTINCT`) until you replace these files with human-reviewed gold (e.g. CRTQA-10176–10184, Jira Smart Checklist exports).
