...
```text
TEST-PREP: CRT-639 benchmark_suite=20260508-ct01 benchmark_attempt=3
```
...
3. Benchmark tokens route outputs to **`attempt-03/shadow/CRT-639/`** ([`docs/benchmark-contract.md`](../../../../../docs/benchmark-contract.md)).

## Optional — `map_only` (same single-line shape)

```text
TEST-PREP: CRT-639 map_only=yes benchmark_suite=20260508-ct01 benchmark_attempt=3
```
