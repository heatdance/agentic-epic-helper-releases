...
**Suite:** `20260413-qa9f`  
**Crossref:** [`.cursor/benchmark/coverage-bench/crossref/CRT-585-prep-metrics.json`](../crossref/CRT-585-prep-metrics.json)  
**Gold:** [`.cursor/benchmark/coverage-bench/data/CRT-585-gold.json`](../data/CRT-585-gold.json) (`pipeline: both` — prep checks applied here)
...
| Label | Path |
|-------|------|
| run-001 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-001.json` |
| run-003 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-003.json` |
| run-005 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-005.json` |
...
| Coverage pass (next queue step) | Run **COVERAGE-VALIDATE: CRT-585 suite=20260413-qa9f** after validating checklist substrings against gold | [`.cursor/benchmark/coverage-bench/pipeline/validator.md`](../pipeline/validator.md); gold `required_smart_checklist_substrings` |

Related playbooks: [`.cursor/benchmark/coverage-bench/pipeline/benchmark-epic-prep.md`](../pipeline/benchmark-epic-prep.md), [`.cursor/pipelines/epic-prep.md`](../../pipelines/epic-prep.md), [Yogi docs](../../../automation/docs/yogi-url-resolve.md).
