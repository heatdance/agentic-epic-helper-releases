...
**Suite:** `20260413-qa9f`  
**Crossref:** [`.cursor/benchmark/coverage-bench/crossref/CRT-585-coverage-metrics.json`](../crossref/CRT-585-coverage-metrics.json)  
**Gold:** [`.cursor/benchmark/coverage-bench/data/CRT-585-gold.json`](../data/CRT-585-gold.json) (`pipeline: both` — coverage checks applied here)
...
| Label | Path |
|-------|------|
| run-002 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-002.json` |
| run-004 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-004.json` |
| run-006 | `.cursor/benchmark/coverage-bench/runs/run-20260413-qa9f/attempts/CRT-585/run-006.json` |
...
Playbooks: [`.cursor/benchmark/coverage-bench/pipeline/benchmark-coverage.md`](../pipeline/benchmark-coverage.md), [`.cursor/pipelines/coverage.md`](../../pipelines/coverage.md).
