...
**Crossref:** [`.cursor/benchmark/coverage-bench/crossref/CRT-669-prep-metrics.json`](../crossref/CRT-669-prep-metrics.json) (`suite_id`: `20260413-qa9f`).

**Gold:** [`.cursor/benchmark/coverage-bench/data/CRT-669-gold.json`](../data/CRT-669-gold.json) — prep checks **pass** (empty required snippet keys).
