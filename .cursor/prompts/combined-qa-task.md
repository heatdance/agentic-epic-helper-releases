...
- **Deliverable**: <!-- test cases per docs/tc-ref, DR per docs/dr-ref; Epic Smart Checklist via COVERAGE: + .cursor/pipelines/coverage.md; Epic analysis via ANALYSE: + .cursor/pipelines/analysis.md; Epic regression test drafts via TEST-PREP: + .cursor/pipelines/test-prep.md (after coverage) -->
